...
if( !yit_get_option( '404-custom' ) ) : ?>
   ...
   <div class="error-404-text group right-text">
    	...
    	<p><?php printf( __( 'There are many ways you can get back on track with Bazar<br />- Go to the <a href="%s">home page</a><br />- Use the search form below', 'yit' ), home_url() ) ?></p>
        <?php get_search_form() ?>
    </div>
<?php
else : 
