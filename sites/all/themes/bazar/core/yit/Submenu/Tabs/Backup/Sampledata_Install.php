...
?>
	<div class="yit_options">
		...
		<p><strong><?php _e('Once you have installed sample data, keep in mind to download and activate Woocommerce!', 'yit') ?></strong></p>
		<?php endif ?>
        ...
        <p><?php _e( '<strong>Note</strong>: If you get errors, please be sure that your server can use the PHP function <strong><a href="http://php.net/manual/en/function.set-time-limit.php">set_time_limit()</a></strong> and the <strong><a href="http://codex.wordpress.org/Editing_wp-config.php#Increasing_memory_allocated_to_PHP">WP_MEMORY_LIMIT</a></strong> value is at least 64M before to write in the support forum.', 'yit' ) ?></p>
        <p><?php _e( 'Once you installed <strong>sample data</strong> if you will get a white page, you need to increase your <strong><a href="http://codex.wordpress.org/Editing_wp-config.php#Increasing_memory_allocated_to_PHP">WP_MEMORY_LIMIT</a></strong> value.', 'yit' ) ?></p>
