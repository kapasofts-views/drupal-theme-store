...
<div id="slider-elastic-0" class="slider slider-elastic elastic ei-slider container" style="">
    ...
    <ul class="ei-slider-large">
        ...
        <li class="first slide-1 slide align-">
            <?php print '<img width="1173" height="339" src="'.file_create_url(path_to_theme() .'/img/slider/paid-drupal-themes.jpg').'" class="attachment-full" alt="drupal paid themes" />';?>

        </li>

        <li class="slide-2 slide align-">
            <?php echo '<img width="1170" height="339" src="'.file_create_url(path_to_theme() .'/img/slider/buy-drupal-theme.jpg').'" class="attachment-full" alt="buy drupal template" />';?>

        </li>

        <li class="last slide-3 slide align-">
            <?php echo '<img width="1173" height="339" src="'.file_create_url(path_to_theme().'/img/slider/top-drupal-themes.jpg').'" class="attachment-full" alt="premium drupal themes" />';?>
    ...
    <ul class="ei-slider-thumbs">
        ...
        <?php echo '<li><a href="#"> - </a><img src="'.file_create_url(path_to_theme() .'/img/slider/premium-drupal-7-themes.jpg').'" alt="top drupal themes" /></li>';?>
        <?php echo '<li><a href="#"> - </a><img src="'.file_create_url(path_to_theme() .'/img/slider/best-drupal-theme.jpg').'" alt="premium drupal themes" /></li>';?>
        <?php echo '<li><a href="#"> - </a><img src="'.file_create_url(path_to_theme() .'/img/slider/drupal-themes.jpg').'" alt="best drupal themes" /></li>';?>
    </ul>
